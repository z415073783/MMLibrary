...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "zengliangmin"
  # spec.authors            = { "zengliangmin" => "415073783@qq.com" }
  # spec.social_media_url   = "https://twitter.com/zengliangmin"
  ...
  spec.source       = { :git => "https://github.com/z415073783/MMLibrary.git", :tag => "#{spec.version}" }
